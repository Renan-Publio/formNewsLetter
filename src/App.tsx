...
function App() {
  ...
  <div className="bg-slate-900 min-h-screen w-full flex flex-col items-center justify-center">
    ...
    <p className="text-slate-100 text-xs w-96 mt-2 text-center">Ao se inscrever, você passará a receber nossos e-mail comas melhores dicas, novidades e ofertas</p>
    </div>
  );
}
